...
ui::SingleWindow::SingleWindow(QWidget *pwgt)
    ...
    m_tab->setTabShape(TabSpecWindow::Triangular);
    ...
    buttonAddTab->setToolTip(tr("Add Tab"));
    ...
    buttonRemoveTab->setToolTip(tr("Remove Tab"));
    ...
    vSpl2->addWidget(m_lstViewSpectrums);
    vSpl2->addWidget(m_lstViewGates);
...
{
    const QString str = QFileDialog::getOpenFileName(nullptr, tr("Open File"), "resources/spectrums/", "*.spm");
    if(str.isEmpty()) {
        return;
    }
